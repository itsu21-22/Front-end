      ...
      <MapWrapper />
            <Card >
              <Card.Body>
                <div class="card_body">
                  <h2 className='text-center'>Про нас</h2>
                    <div class="about_home">
                      {/* <img src={about} class="home_image" alt='' /> */}
                      <div >
                        <p class="text-center"> Якщо Ви це читаєте, це означає те, що Ви потрапили на проект AquaQuality,
                        ...
                        <p class="text-center"> Наша мета - зробити доступ до інформації швидким, стабільним і щоб всі передані нами дані
                ...
                <div class="card_body">
                  <h2 class="text-center">Як дізнатись показники стану водойми?</h2>
                  <p class="text-center">Для цього Вам потрібно вибрати необхідне водосховище на інтерактивній карті, 
